...
import formImg from '../../../../assets/images/sitea/form-img.svg';
        ...
        <>
            <section id="proposal-form-section">
                <div className="container pt-16">
                    <ol className="items-center justify-center w-full space-y-4 sm:flex sm:space-x-3 sm:space-y-0 rtl:space-x-reverse">
                    ...
                    <div className="grid grid-cols-12 gap-20 mt-8">
                        <div className="col-span-4">
                            <img src={formImg} className="h-full w-96" alt="formImg"/>
                        </div>
