...
const Process = () => {
    return (
        <>
            <section id="hiring-section" className="bg-[#F1F2F2] pt-16">
                <div className="container py-16">
                    ...
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        <div className="box flex flex-col items-center text-center">
                            ...
                            <p className="mt-2">
                                First, create a profile to tell us about yourself. Then browse our careers page to
                            </p>
                        </div>
                        ...
                        <div className="box flex flex-col items-center text-center">
                            ...
                            <p className="mt-2">
                                After completing your interviews, we’ll spend time
                            </p>
                        </div>
